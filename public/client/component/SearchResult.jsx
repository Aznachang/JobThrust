    ...
    var resultsList = results.map((result, index) => {
      ...
      return (
        <li key={index} className="search-result">
          <div>
            <h3>{result.jobtitle}<SearchResultIcons index={index} addJob={this.props.addJob} removeJob={this.props.removeJob} result={result} getInfo={this.props.getInfo.bind(null, result.jobkey, index)} /></h3>
